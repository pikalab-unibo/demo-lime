...
setup(
    name="demo-lime",  # Required
    version=version,
    description="Tutorial of LIME technology",
    license="Apache 2.0 License",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/pikalab/demo-lime",
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/pikalab/demo-lime/issues",
        # 'Funding': 'https://donate.pypi.org',
        # 'Say Thanks!': 'http://saythanks.io/to/example',
        "Source": "https://github.com/pikalab/demo-lime",
    },
    cmdclass={
